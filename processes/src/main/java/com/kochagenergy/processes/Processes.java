...
public class Processes {
    ...
    public static void main(String[] args) {
        ...
        final String dbUri = "neo4j+s://neo4j.data-services-dev.kaes.io";
        final String dbUser = "gehad_qaki";
        final String dbPassword = "frog-robin-jacket-halt-swim-7015";
                ...
                locationHopsMap.forEach((locationId, qppMax) -> {
                    session.run("""
                                ...
                                MATCH path = (rr2)(
                                    ...
                                    WHERE point.distance(stop1.coordinate, ol.coordinate) < point.distance(stop2.coordinate, ol.coordinate)
                                ){0,""" + qppMax + """
                                }(rr1:RailRoute)-[:`UAN_FROM`]->()-[:IN_SPLC]->(s1:SPLC)<-[:IN_SPLC]-(ol)
